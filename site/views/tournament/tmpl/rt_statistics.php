...
<ul class="reListTwoCol">
	...
	<li><strong><?php echo JText::_('COM_RETOURNAMENT_TOURNAMENT_STATISTICS_PLACE_1') ?></strong>
		<A href="<?php echo JRoute::_('index.php?option=com_retournament&view=participant&id=' . $this->tournament->place_1_id); ?>">
	...
	<li><strong><?php echo JText::_('COM_RETOURNAMENT_TOURNAMENT_STATISTICS_PLACE_2') ?></strong>
		<A href="<?php echo JRoute::_('index.php?option=com_retournament&view=participant&id=' . $this->tournament->place_2_id); ?>">
			<?php echo $this->escape($this->tournament->place_2_name); ?>
		</A>
	</li>
	<li><strong><?php echo JText::_('COM_RETOURNAMENT_TOURNAMENT_STATISTICS_QT_DRAWS') ?></strong><?php echo $this->tournament->qt_draws; ?></li>
	<li><strong><?php echo JText::_('COM_RETOURNAMENT_TOURNAMENT_STATISTICS_PLACE_3') ?></strong>
		<A href="<?php echo JRoute::_('index.php?option=com_retournament&view=participant&id=' . $this->tournament->place_3_id); ?>">
